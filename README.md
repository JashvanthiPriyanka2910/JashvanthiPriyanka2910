# Hi, I'm Jashvanthi Priyanka 👋

### AI/ML Data & Business Analyst
...
My work spans the analytics lifecycle, including data extraction, transformation, validation, modeling, reporting, and stakeholder communication.

I have experience with:

- Building analytical workflows using SQL and Python
- Developing Power BI dashboards and KPI reporting
- Automating ETL and recurring reporting processes
- Supporting forecasting and predictive-analytics use cases
...
`SQL` `Python` `Power BI` `Excel` `Data Visualization` `KPI Reporting` `Statistical Analysis`

### Data Engineering

`ETL` `Data Cleaning` `Data Validation` `Data Modeling` `Pipeline Automation` `Data Quality`
...
### Honeywell — Data Analyst
**January 2025 – Present | St. Louis, Missouri**

Supporting industrial and enterprise analytics through data pipelines, analytical models, KPI reporting, and business-intelligence solutions.

### Stonedge Technologies and Robotics — Senior Data Analyst
**October 2021 – December 2023 | India**

Contributed to reporting automation, forecasting workflows, data analysis, and scalable data practices.

### Stonedge Technologies and Robotics — Data Analyst Intern
**April 2021 – October 2021 | India**

Supported data preparation, analysis, reporting, and workflow-improvement initiatives.
...
I am interested in professional conversations and opportunities involving data analytics, business intelligence, data engineering, machine learning, healthcare analytics, and industrial analytics.
